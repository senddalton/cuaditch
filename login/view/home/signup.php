...
<div class="fondo-login">
    ...
    <form class="col-3 login" action="store.php" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="password" name="confirmPassword" value="<?= (!empty($_GET['confirmPassword'])) ? $_GET['confirmPassword'] : "" ?>" class="form-control" id="password2">
        </div>
    ...
    <div class="col-3 login mt-3">Tienes cuenta? 
